...
export type Page = 'dashboard' | 'evidence' | 'incidents' | 'orders' | 'violations' | 'visitation' | 'events' | 'reports' | 'profile' | 'players' | 'about' | 'mission' | 'doctrine' | 'howItWorks' | 'access' | 'member' | 'lexicon' | 'declaration' | 'pledge';
